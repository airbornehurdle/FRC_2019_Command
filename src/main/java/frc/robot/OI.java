...
public class OI {
  ...
  //Right Joystick Button(s)
  public static Button pistonFront = new JoystickButton(rightJoystick, 1);

  
  //Left Joystick Button(s)
  public static Button pistonRear = new JoystickButton(leftJoystick, 1);
  ...
  public OI() {
    pistonFront.whenPressed(new FrontPiston_Command());
    pistonRear.whenPressed(new RearPistons_Command());
